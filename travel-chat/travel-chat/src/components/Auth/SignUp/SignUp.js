...
import worldwide from '../../assets/World wide web_Monochromatic 1.svg'
    ...
    return (
        <div className={`${style.wrapper} ${flex.centered_column}`}>
            ...
            <div className={style.privacy_policy}>
                By clicking Continue with Google or Continue with Facebook, you agree to our <a href="#" className={style.privacy_link}>Privacy Policy</a>.
            </div>
            <DescriptionSignUp/>
        </div>
    )
